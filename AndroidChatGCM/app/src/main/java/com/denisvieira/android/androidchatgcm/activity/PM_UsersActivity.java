...
import com.denisvieira.android.androidchatgcm.adapter.UserAdapter;
 ...
 */
public class PM_UsersActivity extends AppCompatActivity {
    
    private static final int PLAY_SERVICES_RESOLUTION_REQUEST = 9000;
    public static final String TAG = "LOG";
    public static final String LIST_KEY = "com.denisvieira.android.androidchatgcm.activity.PM_UsersActivity.LIST_KEY";

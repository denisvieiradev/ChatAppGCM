...
public class User implements Parcelable {
    ...
    public static final String USER_KEY = "com.denisvieira.android.androidchatgcm.domain.User.USER_KEY";
    public static final String USER_TO_KEY = "com.denisvieira.android.androidchatgcm.domain.User.USER_TO_KEY";
    public static final String ID_KEY = "com.denisvieira.android.androidchatgcm.domain.User.ID_KEY";
    public static final String FIRST_TIME_KEY = "com.denisvieira.android.androidchatgcm.domain.User.FIRST_TIME_KEY";

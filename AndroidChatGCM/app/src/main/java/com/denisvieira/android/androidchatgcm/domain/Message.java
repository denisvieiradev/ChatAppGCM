...
public class Message implements Parcelable {
    ...
    public static final String MESSAGE_KEY = "com.denisvieira.android.androidchatgcm.domain.Message.MESSAGE_KEY";
    public static final String MESSAGES_SUMMARY_KEY = "com.denisvieira.android.androidchatgcm.domain.Message.MESSAGES_SUMMARY_KEY";
